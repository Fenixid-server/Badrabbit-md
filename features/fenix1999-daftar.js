...
handler.before = async function (m, { conn, usedPrefix, command }) {
  ...
  if (m.text === "Y") {
    const success =
      `*✅ VERIFY SUCCESS*\n` +
      Func.Styles(`Thank you for registering at ${namebot}, we will store all your information properly in our database, please type *.fenix* to access the ${namebot} features
